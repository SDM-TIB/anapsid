...
from ANAPSID.Decomposer.services import Expression, Argument
import datetime
import operator
...
class Xfilter(object):
    ...
    def evaluateOperator(self, operator, expr_left, expr_right):
        ...
        if operator in unary_operators:
            ...
            return self.evaluateUnaryOperator(None, operator, expr_left)
    ...
    def evaluateUnaryOperator(self, tuple, operator, left):
